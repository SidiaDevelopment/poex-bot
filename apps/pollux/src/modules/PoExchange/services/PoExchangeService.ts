...
import {IPoExchangeFormatter, IPoExchangeUser, IPoExchangeService, IPoExchangeLinks, SellerLabel} from "../formatters/IPoExchangeFormatter"
...
export class PoExchangeService extends Service {
    ...
    private buildVouchButton(disabled: boolean = false): ActionRowBuilder<ButtonBuilder> {
        const button = new ButtonBuilder()
            ...
            .setEmoji("⭐")
            .setLabel(translate("poex.vouch.button"))
