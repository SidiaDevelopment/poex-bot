...
import {VouchButton} from "./buttons/VouchButton"
...
export class PoExchangeModule implements IModule {
    ...
    public services = [PoExchangeService, PoExchangeApiService, MessageVouchService, VouchRoleService]
